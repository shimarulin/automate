...
sudo apt-get -y install libtool valac gobject-introspection intltool libappstream-glib-dev gnome-control-center-dev libgirepository1.0-dev libclutter-1.0-dev
